...
ICONST: Final[Literal[42]] = _example.ICONST
FCONST: Final[float] = _example.FCONST
CCONST: Final[Literal["x"]] = _example.CCONST
CCONST2: Final[Literal["\n"]] = _example.CCONST2
SCONST: Final[Literal["Hello World"]] = _example.SCONST
SCONST2: Final[Literal['"Hello World"']] = _example.SCONST2
EXPR: Final[float] = _example.EXPR
iconst: Final[Literal[37]] = _example.iconst
fconst: Final[float] = _example.fconst
