...
# endif
  ...
  SWIG_Python_SetConstant(d, "ICONST",SWIG_From_int((int)(42)));
  SWIG_Python_SetConstant(d, "FCONST",SWIG_From_double((double)(2.1828)));
  SWIG_Python_SetConstant(d, "CCONST",SWIG_From_char((char)('x')));
  SWIG_Python_SetConstant(d, "CCONST2",SWIG_From_char((char)('\n')));
  SWIG_Python_SetConstant(d, "SCONST",SWIG_FromCharPtr("Hello World"));
  SWIG_Python_SetConstant(d, "SCONST2",SWIG_FromCharPtr("\"Hello World\""));
  SWIG_Python_SetConstant(d, "EXPR",SWIG_From_double((double)(42+3*(2.1828))));
  SWIG_Python_SetConstant(d, "iconst",SWIG_From_int((int)(37)));
  SWIG_Python_SetConstant(d, "fconst",SWIG_From_double((double)(3.14)));
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
