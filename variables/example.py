...
def print_vars() -> None:
    return _example.print_vars()


def new_int(value: int) -> SwigPyObject:
    return _example.new_int(value)


def new_Point(x: int, y: int) -> SwigPyObject:
    return _example.new_Point(x, y)


def Point_print(p: SwigPyObject) -> str:
    return _example.Point_print(p)


def pt_print() -> None:
    return _example.pt_print()


cvar = _example.cvar
cstrvar = cvar.cstrvar
status = cvar.status
path = cvar.path
